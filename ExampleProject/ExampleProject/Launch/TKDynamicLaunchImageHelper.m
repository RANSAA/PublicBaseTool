...
+ (UIImage *)snapshotStoryboard:(NSString *)sbName isPortrait:(BOOL)isPortrait {
    ...
    return [self snapshotViewController:vc isPortrait:isPortrait];
}
...
+ (void)changeAllLaunchImageToPortrait:(UIImage *)image {
    ...
    [TKDynamicLaunchImage replaceLaunchImage:image];
}
...
+ (void)changePortraitLaunchImage:(UIImage *)portraitImage
    ...
    [TKDynamicLaunchImage replaceLaunchImage:portraitImage compressionQuality:0.8 customValidation:^BOOL(UIImage *systemImage, UIImage *yourImage) {
    ...
    [TKDynamicLaunchImage replaceLaunchImage:landscapeImage compressionQuality:0.8 customValidation:^BOOL(UIImage *systemImage, UIImage *yourImage) {
        return [self checkImage:systemImage sizeEqualToImage:yourImage];
    }];
}
